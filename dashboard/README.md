...
- Node.js 18+ and npm
- Backend API running on `https://aigovernancebackend.vercel.app`
...
Dashboard will be available at `https://aigovernanceportal.vercel.app`
...
3. Access at `https://aigovernanceportal.vercel.app`
...
**CORS errors:**
- Ensure backend `ALLOWED_ORIGINS` includes `https://aigovernanceportal.vercel.app`
